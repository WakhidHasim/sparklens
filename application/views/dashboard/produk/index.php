                        ...
                        <tr>
                            ...
                            <td>
                                <div class="justify-content-md-center">
                                    <!-- AR Edit Button -->
                                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ARmodel">AR Model</button>
                                    <!-- AR Edit PopUp start -->
                                    <div class="modal fade" id="ARmodel" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <form role="form" action="<?= base_url('glb_upload/do_upload') ?>" method="POST" enctype="multipart/form-data">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel1">Tambah Model 3D AR</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col mb-3">
                                                                <label for="nameBasic" class="form-label">Nama File 3D Model .glb</label>
