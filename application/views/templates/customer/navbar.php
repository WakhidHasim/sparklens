	...
	<div class="main_menu">
		<nav class="navbar navbar-expand-lg navbar-light main_box">
			<div class="container">
				...
				<a class="navbar-brand logo_h" href="<?= base_url('home'); ?>"><img src="assets/user/img/logo.png"
						alt=""></a>
				...
				<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
					...
					<ul class="nav navbar-nav ml-auto">
						<li class="nav-item"><a href="<?= base_url('cart'); ?>" class="cart"><span
									class="ti-shopping-cart"></span></a></li>
						<li class="nav-item"><a href="<?= base_url('auth'); ?>" class="auth"><span
