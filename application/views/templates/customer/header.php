...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="<?= base_url('assets/user/img/fav.png'); ?>">
	<!-- Author Meta -->
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SparkLens AR Shopping</title>
	<!--
		CSS
		============================================= -->
	<link rel="stylesheet" href="<?= base_url('assets/user/css/linearicons.css'); ?>">
	...
	<link rel="stylesheet" href="<?= base_url('assets/user/css/nouislider.min.css'); ?>">
	<link rel="stylesheet" href="<?= base_url('assets/user/css/ion.rangeSlider.css'); ?>" />
	<link rel="stylesheet" href="<?= base_url('assets/user/css/ion.rangeSlider.skinFlat.css'); ?>" />
...
<body>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav navbar-left">
							...
							<li class="nav-item submenu dropdown">
								<a href="<?= base_url('#'); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
	...
	<script src="assets/user/js/vendor/jquery-2.2.4.min.js"></script>
	<script src="assets/user/https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
	 crossorigin="anonymous"></script>
	<script src="assets/user/js/vendor/bootstrap.min.js"></script>
	...
	<!--gmaps Js-->
	<script src="assets/user/https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
